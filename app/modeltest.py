...
tak = uu().objects.get(username = "tak")
geet = uu().objects.get(username = "geet")

s1 = Snippet.objects.create(author = tak, content = "function hello() {\nconsole.log('hello');\n}", language = "javascript", url_code = "abcde")
#s1.author = tak
s1.tags.add("js")
s1.tags.add("web")
s1.tags.add("dev")
