...
def main():
  ...
  # Make Users.
  Harry = get_user_model().objects.create(username = "harry", email = "harry@gmail.com", password = "harry")
  Emily = get_user_model().objects.create(username = "emily", email = "emily@gmail.com", password = "emily")
  Ramin = get_user_model().objects.create(username = "ramin", email = "ramin@gmail.com", password = "ramin")
  Tyler = get_user_model().objects.create(username = "tyler", email = "tyler@gmail.com", password = "tyler")
  Bella = get_user_model().objects.create(username = "bella", email = "bella@gmail.com", password = "bella")
