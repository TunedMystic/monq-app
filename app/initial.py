...
def main():
  ...
  makeSnippet(author = Drogo, language = "text", title = "what", content = "this is a cool website", visibility = "public", url_code = "hfslj", tags = ["nice", "college", "web"], date = arrow.get(datetime.datetime(2014, 3, 7, 13, 15, 45)).datetime)
  ...
  makeSnippet(author = Drogo, language = "text", title = "oh yea", content = "what?", visibility = "public", url_code = "gfslj", tags = ["what?", "ok", "well", "book"], date = arrow.get(datetime.datetime(2002, 3, 8, 13, 15, 54)).datetime)
